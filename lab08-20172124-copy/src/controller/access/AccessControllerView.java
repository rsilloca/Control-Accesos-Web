			...
			if (userSearch.isEmpty()) {
				...
				if (resourceSearch.isEmpty()) {
					...
					if (accessSearch.isEmpty()){
						...
						Key kRole =	KeyFactory.createKey(Role.class.getSimpleName(), a.getIdRole());
						Role r = persistenceManager.getObjectById(Role.class, kRole);
						request.setAttribute("role", r);
						
						Key kResource =	KeyFactory.createKey(Resource.class.getSimpleName(), a.getIdUrl());
						Resource resource = persistenceManager.getObjectById(Resource.class, kResource);
