...
<body>
	<div class="main">
		...
		<ul>
			...
			<li><a href="/resources/view?id=<%=r.getId()%>">Back</a></li>
		</ul>
		</nav>
		<div class="usersEdit">
			<center>
				...
				<table>
					...
					<tr>
						...
						<td><form action="resources/edit" method="post">
								<input type="hidden" name="id" value="<%=r.getId()%>"><input
									type="text" name="url"></td>
					</tr>
					<tr>
						<td class="title"><center>
								<h3>Status</h3>
				...
				<a href="/resources/view?id=<%=r.getId()%>">Cancel</a>
			</center>
		</div>
	</div>
</body>
